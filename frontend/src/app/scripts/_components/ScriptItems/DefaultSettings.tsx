...
export default function DefaultSettings({ item }: { item: Script }) {
  ...
  const ResourceDisplay = ({ settings, title }: { 
  ...
  const hasDefaultSettings = defaultSettings?.resources &&
  ...
  return (
    <>
      ...
      {defaultAlpineSettings && (
        <ResourceDisplay settings={defaultAlpineSettings} title="Default Alpine settings" />
      )}
    </>
  );
}
